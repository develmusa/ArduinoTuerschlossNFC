...
char secretCode[] = {button3, button3, button3, button3};
 ...
 *         False if not*/
{
  Serial.println(idcard); //you need to add the id of your authorized card here instead of 0's
  if (idcard == 1139634415)
  {
    Serial.println("Card1");
    return true;
  }
  else if (idcard == 3845351192)
  {
